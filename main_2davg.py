...
from model_2davg import get_inplanes, BasicBlock, ResNet, Bottleneck
...
# )
    ...
    print('training loss: %.4f, accuracy= %.4f, concordance = %.4f' % (train_loss, accracy, 1-ctd[0]))
    # print(ctd1)
...
def train():
    ...
    optimizer=torch.optim.Adam(learnable_params, weight_decay=0)
